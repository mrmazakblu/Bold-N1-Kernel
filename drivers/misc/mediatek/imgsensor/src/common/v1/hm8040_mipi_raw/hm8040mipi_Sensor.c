...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0x2b7d508e, //0x381e7cd3,        //checksum value for Camera Auto Test
...
//            LOG_INF("Warning: current_fps %d fps is not support, so use cap1's setting: %d fps!\n",imgsensor_info.cap1.max_framerate/10,imgsensor_info.cap1.max_framerate/10);
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
 ...
 if(enable)
    {
        write_cmos_sensor(0x3110,0x00); // BPC OFF
        write_cmos_sensor(0x4144,0x00); // BLC OFF
        write_cmos_sensor(0x4145,0x00); // CFPN OFF
        write_cmos_sensor(0x4146,0x00); // CFPN IIR OFF   
        write_cmos_sensor(0x0601, 0x02);
    }
    else{
        write_cmos_sensor(0x3110,0x01); // BPC ON
        write_cmos_sensor(0x4144,0x03); // BLC ON
        write_cmos_sensor(0x4145,0x33); // CFPN ON
        write_cmos_sensor(0x4146,0x31); // CFPN IIR ON   
        write_cmos_sensor(0x0601,0x00);
        }
