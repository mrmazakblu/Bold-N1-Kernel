...
/*dingjun add 20171215 for AF en*/
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    {
        case IMAGE_NORMAL:
            write_cmos_sensor_8(0x0101, iTemp);    //Set normal gr
            break;
        case IMAGE_H_MIRROR:
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
			printk("%s,%d imx134 *sensor_id=0x%x\n", __func__,__LINE__,*sensor_id);
...
static kal_uint32 open(void)
{
	...
	imgsensor.gain = 0;
       ...
       /*dingjun add 20171215 add for back camera AF en*/
	//mt6357_upmu_set_rg_ldo_vldo28_en(1);   
	//aeon_gpio_set("back_cam_af_en_high");
	spin_lock(&imgsensor_drv_lock);
...
static kal_uint32 close(void)
{
    ...
    /*No Need to implement this function*/ 
       /*dingjun add 20171215 add for back camera AF en*/
	//aeon_gpio_set("back_cam_af_en_low");
