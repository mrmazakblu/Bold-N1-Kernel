...
#endif
#if  0
static kal_uint16 s5k5e9yx_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				printk("s5k5e9 i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			printk("s5k5e9 Read sensor id fail, i2c_write_id: 0x%x\n",
