...
static void sensor_init(void)
{
	...
	/*prize  modify by zhuzhengjiang for static contributes 20191022-begin*/
	write_cmos_sensor_8(0x4800, 0x60);// 00
	write_cmos_sensor_8(0x3106, 0x80);// 00
	/*prize  modify by zhuzhengjiang for static contributes 20191022-end*/
