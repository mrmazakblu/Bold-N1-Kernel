...
static void set_shutter(kal_uint16 shutter)
{
	...
	kal_uint16 realtime_fps = 0; /*prize  add  for cts test:testPreviewFpsRange by zhuzhengjiang    20191018-start*/
	...
	shutter = (shutter >> 1) << 1; /*prize  add  for cts test:testPreviewFpsRange by zhuzhengjiang    20191018-start*/
	if (shutter > 16383)
		shutter = 16383;
	if (shutter < 1)
		shutter = 1;
	/*prize  add  for cts test:testPreviewFpsRange by zhuzhengjiang    20191018-start*/
	...
	// Update Shutter
    /*prize  add  for cts test:testPreviewFpsRange by zhuzhengjiang    20191018-end*/
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0x03, (shutter >> 8) & 0x3f);
	write_cmos_sensor(0x04, shutter & 0xff);
	set_dummy();/*prize  add  for cts test:testPreviewFpsRange by zhuzhengjiang    20191018-start*/
...
/*prize  add  for dual camera   stagnancy by zhuzhengjiang    20191009-begin*/
/*************************************************************************
 * FUNCTION
...
/*prize  add  for dual camera   stagnancy by zhuzhengjiang    20191009-end*/
