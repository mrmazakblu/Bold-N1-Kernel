...
//---------------------------------------------------------------------------------
#define SF_DRV_VERSION "v2.2.37-2018-12-20"
...
/* prize added by chenjiaxi, sunwave fingerprint info, 20190115-start */
#if defined(CONFIG_PRIZE_HARDWARE_INFO)
#include "../../../../misc/mediatek/hardware_info/hardware_info.h"
extern struct hardware_info current_fingerprint_info;
#endif
/* prize added by chenjiaxi, sunwave fingerprint info, 20190115-end */
...
/* prize added by chenjiaxi, sunwave fingerprint info, 20190115-start */
#if defined(CONFIG_PRIZE_HARDWARE_INFO)
	sprintf(current_fingerprint_info.chip,"sunwave_fp_tee");
